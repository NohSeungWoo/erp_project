...
public class GoogleMail_KGH {
	...
	public void sendmail(String recipient, String certificationCode) throws Exception {
		...
		// 제목 설정
		String subject = "localhost:9090/finalProject/index.gw 회원님의 비밀번호를 찾기 위한 인증코드 발송";
		...
		msg.setContent("<div style=\"border: solid 10px #666699; width: 350px; height: 180px; margin-top: 50px; margin-left: 50px; padding-top: 30px; padding-left: 30px;\">" + 
						"        <h3>그룹웨어 인증코드</h3>" + 
						"        <span style=\"margin-top:20px; font-size: 11pt;\">회원님의 인증코드는 <span style=\"font-weight: bold;\">" + certificationCode + "</span>&nbsp;입니다.</span>" + 
