...
<%
   String ctxPath = request.getContextPath(); // finalProject
%>    
...
<title>Home(1조)</title>
  ...
  <!-- Bootstrap CSS -->
  <link rel="stylesheet" type="text/css" href="<%= ctxPath%>/resources/bootstrap-4.6.0-dist/css/bootstrap.min.css" > <!-- servlet-context.xml의 #18을 참고하면, 부트스트랩은 resources폴더 아래에 들어가야함 -->
