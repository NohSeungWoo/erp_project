...
<title>Board(1조)</title>
  ...
  <style type="text/css">
	...
	#mysideinfo    { min-height:750px; position: relative; padding-top: 40px;
	                 float:left; width:19%; }
	                 
	#mycontent     { min-height:750px; position: relative; padding-top: 40px; /* background-color:#f4f5f7; */ border-left: solid 1px gray;
