			...
			<table class="table table-bordered">
				<thead>
					<tr style="text-align: center; background-color: #fafafa;">
						...
						<th style="width: 200px;  text-align: center">문서상태</th>
				...
				<tbody>
						<c:if test="${not empty requestScope.approvalList}">
							...
							<tr class="listtr">
								...
								<c:if test="${apList.apstatus == 0 }">
									<td class="" align="center">진행</td>
								</c:if>
								<c:if test="${apList.apstatus == 1 }">
									<td class="" align="center">완료</td>
								</c:if>
								<c:if test="${apList.apstatus == 2 }">
									<td class="" align="center">반려</td>
								</c:if>
